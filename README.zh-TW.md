...
# LEARNING LPIC-3 305-300 - 測試翻譯 02/07/2025
...
自定義網路配置在文件 [configs/network](configs/network/) 中。
...
切換 *Vagrantfile-topic-xxx* 模板並複製到一個名為 *Vagrantfile* 的新文件中
...
* 🔧 更靈活，適合開發、測試和小規模部署。
* 🐢 通常比類型 1 Hypervisors 效率低，因為主機操作系統的額外開銷。

###### 類型 2 範例

* VMware Workstation：在單個桌面上運行多個操作系統的強大 Hypervisor。
* Oracle VirtualBox：以靈活性和易用性著稱的開源 Hypervisor。
* Parallels Desktop：為 Mac 用戶設計，能夠與 macOS 一起運行 Windows 和其他操作系統。
