...
Para iniciar o aprendizado, veja a documentação acima.
...
### Use o powershell para subir e descer
...
* ⚖️ Compreender os prós e contras da virtualização
* 🛠️ Compreender as várias variações de Hypervisores e Monitores de Máquinas Virtuais
...
* 📸 Compreender os recursos e implicações da virtualização para uma máquina virtual, como instantâneas, pausa, clonagem e limites de recursos
...
* Gerenciamento e Facilidade de Uso:
  * Hypervisores Tipo 1 requerem configuração e gerenciamento mais complexos, mas fornecem recursos avançados e escalabilidade para implantações em grande escala.
...
###### Principais Características de HVM
