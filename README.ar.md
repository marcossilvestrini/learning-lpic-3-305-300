...
استخدم Vagrantfile-topic-XXX للمعامل.
...
-   **تعديل نظام التشغيل الضيف:** Requires modifications to the guest OS, limiting compatibility to supported operating systems.
...
أجهزة HVM-DomUs عبارة عن أجهزة افتراضية تستخدم المحاكاة الافتراضية الكاملة، مما يسمح بتشغيل أنظمة التشغيل غير المعدلة. يوفر برنامج Hypervisor Xen محاكاة الأجهزة لوحدات DomUs هذه، مما يمكّنها من تشغيل أي نظام تشغيل يدعم بنية الأجهزة الأساسية.  
