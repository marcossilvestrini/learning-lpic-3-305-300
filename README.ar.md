...
يشير ترحيل V2V إلى عملية ترحيل جهاز افتراضي من برنامج Hypervisor إلى آخر. في هذه الحالة، لديك بالفعل جهاز ظاهري يعمل في بيئة افتراضية (مثل VMware)، وتريد نقله إلى بيئة افتراضية أخرى (على سبيل المثال، إلى Hyper-V أو إلى خادم VMware جديد).
...
-   **Paravirtualization:**يعتمد على العزل المعتمد على البرمجيات، والذي قد لا يكون بقوة العزل المعتمد على الأجهزة.
