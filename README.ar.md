...
Customize network configuration in files [التكوينات/الشبكة](configs/network/).
...
-   **HVM:**بشكل عام، يكون النشر أكثر وضوحًا نظرًا لأنه يدعم نظام التشغيل غير المعدل.
...
أجهزة الشبكة الافتراضية![pv-networking](images/xen-networking2.png)

التجسير![pv-networking](images/xen-networking1.png)
...
-   [زين](<>)
    ...
    -   [أدوات زين](https://xen-tools.org/software/)
