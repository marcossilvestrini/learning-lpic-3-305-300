...
تقليديًا في Linux ، يتمتع المستخدم الجذر بالوصول غير المقيد إلى النظام. تم تقديم إمكانيات Linux لتكسير هذه الامتيازات القوية إلى أذونات أصغر ومنفصلة ، مما يسمح للعمليات بأداء عمليات محددة مميزة دون الحاجة إلى الوصول الكامل للجذر.
