...
مساحات الأسماء هي ميزة Kernel الأساسية Linux تتيح العزلة على مستوى العملية. يقومون بإنشاء "طرق عرض" منفصلة لموارد النظام العالمية - مثل معرفات العملية والشبكات وأنظمة الملفات والمستخدمين - بحيث تعتقد كل مجموعة من عملياتها أنها تعمل في نظامها الخاص.
