...
-   **أداء:** High performance due to hardware support.
...
-   [رخصة](<>)
    ...
    -   [رخصة LTS](https://en.wikipedia.org/wiki/Long-term_support)
-   [توزيعات](<>)
...
-   [زين](<>)
    ...
    -   [محاكاة Xen الافتراضية والحوسبة السحابية #02: كيف يقوم Xen بالمهمة](https://www.lpi.org/blog/2020/10/08/xen-virtualization-and-cloud-computing-02-how-xen-does-job/)
-   [مستندات Openstack](<>)
