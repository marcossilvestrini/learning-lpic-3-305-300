...
استخدم Vagrantfile-topic-XXX لتخصيص أجهزة افتراضية للمختبرات.
...
-   **التوافق:** Can run any operating system without modification.
...
**وصف:** Candidate should be able to manage Docker nodes and Docker containers. This include understand the architecture of Docker as well as understanding how Docker interacts with the node’s Linux system.
