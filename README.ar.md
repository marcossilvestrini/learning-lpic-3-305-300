...
-   **Inter-Domain Communication:**يتيح Xen Store الاتصال بين المجالات، مثل Dom0 (المجال المميز الذي يتحكم في موارد الأجهزة) وDomUs (نطاقات المستخدم، وهي الأجهزة الافتراضية). ويتم ذلك من خلال إدخالات القيمة الرئيسية، حيث يمكن لكل مجال قراءة المعلومات أو كتابتها.
