...
**تعريف:**يتم تشغيله مباشرة على الأجهزة المادية للمضيف، مما يوفر طبقة أساسية لإدارة الأجهزة الافتراضية دون الحاجة إلى نظام تشغيل مضيف.
...
**تعريف**: تعمل تقنية HVM على تعزيز امتدادات الأجهزة التي توفرها وحدات المعالجة المركزية (CPUs) الحديثة لإضفاء الطابع الافتراضي على الأجهزة، مما يتيح إنشاء الأجهزة الافتراضية وإدارتها بأقل قدر من الأداء.
...
**أمثلة:**VMware ESXi، Microsoft Hyper-V، KVM (الجهاز الظاهري القائم على Kernel).
...
**تعريف:**تتضمن المحاكاة الافتراضية تعديل نظام التشغيل الضيف ليكون على دراية بالبيئة الافتراضية، مما يسمح له بالتفاعل بشكل أكثر كفاءة مع برنامج Hypervisor.
...
**حالات الاستخدام:**مراكز البيانات، الحوسبة السحابية، توحيد الخوادم.**أمثلة:**إم وير إي إس إكس آي، ومايكروسوفت هايبر- في، وكيه في إم.

##### المحاكاة الافتراضية لنظام التشغيل (الحاويات)

**تعريف:**يسمح بتشغيل مثيلات مساحة المستخدم المعزولة المتعددة (الحاويات) على نواة نظام تشغيل واحدة.**حالات الاستخدام:**بنية الخدمات الصغيرة وبيئات التطوير والاختبار.**أمثلة:**دوكر، كوبيرنيتيس، LXC.

##### المحاكاة الافتراضية للشبكة

**تعريف:**يجمع موارد شبكة الأجهزة والبرامج في كيان إداري واحد قائم على البرامج.**حالات الاستخدام:**الشبكات المعرفة بالبرمجيات (SDN)، والمحاكاة الافتراضية لوظيفة الشبكة (NFV).**أمثلة:**VMware NSX، Cisco ACI، OpenStack Neutron.

##### المحاكاة الافتراضية للتخزين

**تعريف:**يجمع التخزين الفعلي من أجهزة متعددة في وحدة تخزين افتراضية واحدة يمكن إدارتها مركزيًا.**حالات الاستخدام:**إدارة البيانات، وتحسين التخزين، والتعافي من الكوارث.**أمثلة:**وحدة تحكم حجم IBM SAN، VMware vSAN، NetApp ONTAP.

##### المحاكاة الافتراضية لسطح المكتب

**تعريف:**يسمح لنظام تشغيل سطح المكتب بالعمل على جهاز افتراضي مستضاف على خادم.**حالات الاستخدام:**البنية التحتية لسطح المكتب الافتراضي (VDI)، وحلول العمل عن بعد.**أمثلة:**تطبيقات وأجهزة سطح المكتب الافتراضية من Citrix، وVMware Horizon، وخدمات Microsoft Remote Desktop.

##### المحاكاة الافتراضية للتطبيق

**تعريف:**يفصل التطبيقات عن الأجهزة الأساسية ونظام التشغيل، مما يسمح لها بالعمل في بيئات معزولة.**حالات الاستخدام:**نشر التطبيق المبسط واختبار التوافق.**أمثلة:**VMware ThinApp، Microsoft App-V، Citrix XenApp.

##### المحاكاة الافتراضية للبيانات

**تعريف:**يدمج البيانات من مصادر مختلفة دون دمجها فعليًا، مما يوفر رؤية موحدة للتحليل وإعداد التقارير.**حالات الاستخدام:**ذكاء الأعمال، وتكامل البيانات في الوقت الحقيقي.**أمثلة:**دينودو، ريد هات JBoss البيانات الافتراضية، آي بي إم إنفوسفير.

##### فوائد المحاكاة الافتراضية

**كفاءة الموارد:**استغلال أفضل للموارد المادية.**وفورات في التكاليف:**انخفاض تكاليف الأجهزة والتشغيل.**قابلية التوسع:**من السهل توسيع نطاقه أو خفضه حسب الطلب.**المرونة:**يدعم مجموعة متنوعة من أعباء العمل والتطبيقات.**التعافي من الكوارث:**عمليات النسخ الاحتياطي والاسترداد المبسطة.**عزل:**تحسين الأمان من خلال عزل البيئات.
...
-   فهم مفاهيم حاوية النظام والتطبيق
