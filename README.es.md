...
# APRENDIENDO LPIC-3 305-300

![LPIC3-305-300](images/lpic3-305-300.jpg)

<p align="center">
<strong>Explorar la documentación »</strong></a>
    <br />
    ...
    -
    <a href="https://github.com/marcossilvestrini/learning-lpic-3-305-300/issues">Solicitar Funcionalidad</a>
</p>
...
<details>
  ...
  <ol>
    ...
    <li>
      <a href="#topic-353">Tema 353: Despliegue y Aprovisionamiento de VM</a>
      <ul>
...
* Microsoft Hyper-V: Integrado con Windows Server, ofreciendo un rendimiento y características de gestión sólidas.
...
* Entorno de Despliegue:
  * Los hipervisores Tipo 1 se implementan comúnmente en centros de datos y entornos empresariales debido a su interacción directa con el hardware y alto rendimiento.
...
HVM aprovecha las extensiones de hardware proporcionadas por las CPU modernas para virtualizar hardware, permitiendo la creación y gestión de VMs con una sobrecarga de rendimiento mínima.
...
* ⚡ **Rendimiento:** Ofrece un rendimiento casi nativo debido a la ejecución directa del código invitado en la CPU.
